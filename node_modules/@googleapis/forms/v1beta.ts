...
export namespace forms_v1beta {
   ...
   * const forms = google.forms('v1beta');
   * ```
   */
  export class Forms {
  ...
  export interface Schema$Grading {
    ...
    /**
     * If no correct answers are provided, this maybe set to the feedback that is displayed for all answers. This is commonly used for short answer questions when a quiz owner wants to quickly give respondents some sense of whether they answered the question correctly before they've had a chance to officially grade the response.
     */
    ...
    /**
     * If correct answers are provided, this must be set to the feedback that is displayed for correct answers. Otherwise this must not be set.
     */
    whenRight?: Schema$Feedback;
    /**
     * If correct answers are provided, this must be set to the feedback that is displayed for incorrect answers. Otherwise this must not be set.
     */
  ...
  export interface Schema$Info {
    ...
    /**
     * Output only. The title of the document which is visible in Drive. If `Info.title` is empty, `document_title` may appear in its place in the Google Forms UI and be visible to responders. `document_title` can be updated using the Google Drive API.
     */
  ...
  export interface Schema$Watch {
    ...
    /**
     * Deprecated. Please rely instead on the ID of the affected form, which is included in the payload of each notification. Per-watch data handed back with each notification. For Pub/Sub targets this will be the value of the `data` field. It can have at most 1K bytes.
     */
  ...
  export class Resource$Forms {
    ...
    batchUpdate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/forms/{formId}:batchUpdate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    /**
     * Create a new form using the title given in the provided form message in the request. *Important:* Only the form.info.title field is copied to the new form. All other fields including the form description, items and settings are disallowed. To create a new form and add items, you must first call forms.create to create an empty form with a title then call forms.update to add the items.
     * @example
     * ```js
     * // Before running the sample:
     * // - Enable the API at:
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/forms').replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ),
    ...
    get(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/forms/{formId}').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Forms$Responses {
    ...
    get(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta/forms/{formId}/responses/{responseId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/forms/{formId}/responses').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Forms$Watches {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/forms/{formId}/watches').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    delete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/forms/{formId}/watches/{watchId}').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'DELETE',
    ...
    renew(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta/forms/{formId}/watches/{watchId}:renew'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
